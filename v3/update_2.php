...
<div class="container">
	<div class="row" style="text-align:center;">                                                                                                  
		<h1 style="padding-top:50px; color:#FFF">正在生成SQL脚本...[2 / 4]</h1>
...
<?php
	flush();
	exec("cp ./script/* ./upload");
	exec("python ./upload/parsexml3.0.py");
	echo "<script>window.location.href=\"update_3.php\";</script>\n";
?>
</body>
</html>
